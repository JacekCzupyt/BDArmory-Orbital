...
namespace BDArmory.Weapons.Missiles
{
    public abstract class MissileBase : EngageableWeapon, IBDWeapon
    {
        ...
        public enum GuidanceModes { None, AAMLead, AAMPure, AGM, AGMBallistic, Cruise, STS, Bomb, RCS, BeamRiding, SLW, PN, APN, AAMLoft, Vacuum }
        ...
        protected void UpdateRadarTarget()
        {
            ...
            else if (radarLOAL && radarLOALSearching) //add a check for missing radar, so LOAL missiles that have been dumbfired can still activate?
            {
                ...
                float sqrThresh = targetVessel != null ? 1000000f : activeRadarRange*activeRadarRange; // 1000 * 1000 : radarrange^2; Expand threshold if no target to search for, grab first available target
